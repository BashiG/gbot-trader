...
**Важно!** Если рынок успокоился и дельта цен вернулась в допустимый предел, то открытые ордера останутся на своих позициях до тех пор пока они не будут исполнены либо вы не закроете их вручную используя Telegram (**Закрыть активные ордера**) или перезапуск бота. 
...
6. **Внимание!** Если по какой-то причине StopLoss дал команду на установку ордера, а профитный ордер не установился, то будет выслано в Telegram уведомление об ошибке **Problem with StopLoss active**.
