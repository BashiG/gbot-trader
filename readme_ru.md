...
> Параметр **ONE_ORDERS_OFFSET** не может быть меньше **OFFSET_FIRST_ORDERS_PERCENT** или его эквивалента в **OFFSET_FIRST_ORDERS_POINTS**.
...
NOTIFICATION_DEVIATION_PERCENT      | Насколько процентов должен увеличиться спред, чтобы сработало уведомление | number | 600
